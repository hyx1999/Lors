...
class LlamaSdpaAttention(LlamaAttention):
    ...
    def forward(
        ...
        **kwargs,
        ...
        attn_output = attn_output * self.mask.repeat(attn_output.shape[0], 1).view(attn_output.shape[0], 32, 1, 1)
        attn_output = attn_output.transpose(1, 2).contiguous()
...
config = AutoConfig.from_pretrained('checkpoints/TinyLlama-1.1B-Chat')

inputs = torch.randn(4, 4, config.hidden_size)
